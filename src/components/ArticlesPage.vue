      ...
      try {
        const response = await fetch(`${host}/api/ai`, {
          ...
          body: JSON.stringify({
            ...
            userPrompt: `Напиши статью на тему: "${topic}". Без лишних фраз. 
                          Пиши по делу, на русском языке. Отвечай только если запрос связан с образованием и поступлением и тд. 
                          Имей ввиду что ты из Казахстана, пишешь и отвечаешь про Казахстан и как ее гражданин.
                          Не уточняй данные условий из промпта!`,
          }),
        });
